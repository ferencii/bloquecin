*   **Asistente IA contextual**:
    ...
    *   El texto del usuario se muestra en blanco y el de la IA en verde para distinguirlos.
...
*   **Mejoras en la Sección Sets**:
    *   Se corrigió la importación para reconocer múltiples tiers y leer los affects correctamente.
    *   Se ajustó la generación para incluir `#` en el identificador y cerrar cada tier con `End`.
    *   Se añadió la inicialización de tarjetas para conservar el colapsado individual incluso tras usar "Contraer Todo".
